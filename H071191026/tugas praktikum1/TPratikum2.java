...
class TPratikum2{
    public static void main(String[] args) {
        ...
        System.out.println("2. Mencari Volume Bnagun Ruang");
            ...
            case 1  : 
                ...
                switch (b){
                    case 1 : 
                        ...
                        int sisi = sc.nextInt();
                        System.out.println("luas persegi panjang = " + (sisi*sisi));
                        break;
                    case 2 :
                ...
                case 2 :
                    ...
                    switch (c){
                        case 1 : 
                            System.out.println("input sisi");
                            int sisi = sc.nextInt();
                            System.out.println("volime kubus = " + (sisi*sisi*sisi));
                            break;
                        case 2 :
                            System.out.println("input panjang");
                            int panjang = sc.nextInt();
                        ...
                        case 4 : 
                            ...
                            System.out.println("volume luas segiempat = " + (luasAlas*tinggiii)/3);
                            break;
                        case 5 :
                            ...
                            System.out.println("volume luas segitiga = " + (luassAlass*tinggi1)/3);
                            break;
                        case 6 :
